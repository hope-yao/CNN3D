...
with open('./potcup20161213-220326/potcup', "rb") as f:
...
conv_ram = model.get_top_bricks()[0]
...
l, y_hat, c = conv_ram.classify(x)
# f = theano.function([x], [l, y_hat, rho_orig, rho_larger, rho_largest])
f = theano.function([x], [l, y_hat, c])

mnist_train = H5PYDataset('../data/potcup_hollow_vox.hdf5', which_sets=('test',))
...
l = ll*32
cx,cy,cz = ll[:,0,0]*32+16,ll[:,0,1]*32+6,ll[:,0,2]*32+16
...
# ax_mnist.axis('equal')
ax_mnist.set_xlim3d(0,32)
ax_mnist.set_ylim3d(0,32)
ax_mnist.set_zlim3d(0,32)
...
ax_glimpse0.set_xlim3d(0,32)
ax_glimpse0.set_ylim3d(0,32)
ax_glimpse0.set_zlim3d(0,32)
ax_glimpse1.set_xlim3d(0,32)
ax_glimpse1.set_ylim3d(0,32)
ax_glimpse1.set_zlim3d(0,32)
ax_glimpse2.set_xlim3d(0,32)
ax_glimpse2.set_ylim3d(0,32)
ax_glimpse2.set_zlim3d(0,32)
ax_glimpse3.set_xlim3d(0,32)
ax_glimpse3.set_ylim3d(0,32)
ax_glimpse3.set_zlim3d(0,32)
ax_glimpse4.set_xlim3d(0,32)
ax_glimpse4.set_ylim3d(0,32)
ax_glimpse4.set_zlim3d(0,32)
# ax_glimpse0.axis([0, 32, 0, 32, 0, 32])
# ax_glimpse1.axis([0, 32, 0, 32, 0, 32])
# ax_glimpse2.axis([0, 32, 0, 32, 0, 32])
# ax_glimpse3.axis([0, 32, 0, 32, 0, 32])
# ax_glimpse4.axis([0, 32, 0, 32, 0, 32])
...
ax_canvas0.set_xlim3d(0,32)
ax_canvas0.set_ylim3d(0,32)
ax_canvas0.set_zlim3d(0,32)
ax_canvas1.set_xlim3d(0,32)
ax_canvas1.set_ylim3d(0,32)
ax_canvas1.set_zlim3d(0,32)
ax_canvas2.set_xlim3d(0,32)
ax_canvas2.set_ylim3d(0,32)
ax_canvas2.set_zlim3d(0,32)
ax_canvas3.set_xlim3d(0,32)
ax_canvas3.set_ylim3d(0,32)
ax_canvas3.set_zlim3d(0,32)
ax_canvas4.set_xlim3d(0,32)
ax_canvas4.set_ylim3d(0,32)
ax_canvas4.set_zlim3d(0,32)
# ax_canvas0.axis([0, 32, 0, 32, 0, 32])
# ax_canvas1.axis([0, 32, 0, 32, 0, 32])
# ax_canvas2.axis([0, 32, 0, 32, 0, 32])
# ax_canvas3.axis([0, 32, 0, 32, 0, 32])
# ax_canvas4.axis([0, 32, 0, 32, 0, 32])
...
# for i in range(conv_ram.n_iter-1):
for i in range(conv_ram.n_iter):
    x = cx[i]
    y = cy[i]
    z = cz[i]
    plot_cube(ax_mnist,x-conv_ram.read_N/2. , y-conv_ram.read_N/2.,z-conv_ram.read_N/2., conv_ram.read_N, 0.1, i)
...
glimpse0[:,:,:] = c[glimpse_idx,0,:].reshape(32,32,32)
canvas0 = glimpse0
...
# # glimpse_idx = glimpse_idx + 1
# glimpse1[:,:,:] = c[glimpse_idx,0,:].reshape(32,32,32)
# canvas1 = glimpse1 + canvas0
...
# # glimpse_idx = glimpse_idx + 1
# glimpse2[:,:,:] = c[glimpse_idx,0,:].reshape(32,32,32)
# canvas2 = glimpse2 + canvas1
...
# glimpse_idx = glimpse_idx + 1
# glimpse3[:,:,:] = c[glimpse_idx,0,:].reshape(32,32,32)
# canvas3 = glimpse3 + canvas2
